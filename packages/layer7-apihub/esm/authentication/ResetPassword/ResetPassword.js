...
export const ResetPasswordPage = props => {
    ...
    return (React.createElement(Layout, Object.assign({}, props), username ? (React.createElement(ResetPasswordConfirm, null)) : (React.createElement(ResetPasswordForm, { onSubmit: onSubmit }))));
};
