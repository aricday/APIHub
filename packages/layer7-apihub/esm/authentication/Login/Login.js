...
export const LoginPage = props => {
    ...
    return (React.createElement(Layout, Object.assign({}, props),
        simpleCredentialsEnabled ? React.createElement(LoginForm, null) : null,
        signUpEnabled ? React.createElement(SignUp, null) : null));
};
export const SignUp = props => {
    const classes = useStyles(props);
    const translate = useTranslate();
    return (React.createElement(React.Fragment, null,
        React.createElement(Typography, { variant: "h2", className: classes.signUpTitle, color: "textSecondary" }, translate('apihub.login.actions.sign_up_title')),
        React.createElement(Button, { component: Link, to: "/signup", variant: "outlined", color: "primary", disabled: true }, translate('apihub.login.actions.sign_up'))));
};
