...
const local_storage_1 = require("@rehooks/local-storage");
 ...
 *
 */
exports.useApiHubPreference = (preferenceName, defaultPreference) => {
    return local_storage_1.useLocalStorage(`${DEFAULT_STORAGE_KEY}/${preferenceName}`, defaultPreference);
};
/**
 ...
 *
 */
exports.readApiHubPreference = (preferenceName, defaultPreference) => {
    return (localStorage.getItem(`${DEFAULT_STORAGE_KEY}/${preferenceName}`) ||
        defaultPreference);
};
/**
 ...
 *
 */
exports.writeApiHubPreference = (preferenceName, newPreference) => {
    localStorage.setItem(`${DEFAULT_STORAGE_KEY}/${preferenceName}`, newPreference);
};
//# sourceMappingURL=useApiHubPreferences.js.map