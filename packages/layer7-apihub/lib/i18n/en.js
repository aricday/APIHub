...
const apiHubMessages = {
    ra: Object.assign(Object.assign({}, ra_language_english_1.default), { page: {
            dashboard: 'Home',
        }, actions: Object.assign(Object.assign({}, ra_language_english_1.default.actions), { open_sidebar: 'Open the menu', close_sidebar: 'Close the menu' }), navigation: Object.assign(Object.assign({}, ra_language_english_1.default.navigation), { page_rows_per_page: 'Items per page:' }) }),
    apihub: {
        login: {
        ...
        homepage: {
            placeholder_empty_content: 'The home page content has not been provided yet. Please use the edition button to create it if you are a portal administrator.',
        },
        actions: {
...
exports.default = react_admin_1.mergeTranslations(ra_language_english_1.default, apiHubMessages);
