...
const apiHubMessages = {
    ra: Object.assign(Object.assign({}, ra_language_french_1.default), { page: {
            dashboard: 'Accueil',
        }, actions: Object.assign(Object.assign({}, ra_language_french_1.default.actions), { open_sidebar: 'Ouvrir le menu', close_sidebar: 'Fermer le menu' }), navigation: Object.assign(Object.assign({}, ra_language_french_1.default.navigation), { page_rows_per_page: 'Eléments par page :' }) }),
    apihub: {
        login: {
...
exports.default = react_admin_1.mergeTranslations(ra_language_french_1.default, apiHubMessages);
