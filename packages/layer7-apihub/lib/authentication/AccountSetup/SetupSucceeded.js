...
exports.SetupSucceeded = props => {
    const translate = ra_core_1.useTranslate();
    const classes = useStyles(props);
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(core_1.Typography, { variant: "body1", className: classes.root }, translate('apihub.account_setup.notifications.success')),
...
//# sourceMappingURL=SetupSucceeded.js.map