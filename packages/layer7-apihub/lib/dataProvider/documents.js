...
exports.buildDocumentId = (entityType, entityUuid, navtitle, locale) => {
...
exports.documentsDataProvider = baseUrl => {
    return {
        getList: async ({ filter }) => {
            ...
            return {
                data: json.map(item => (Object.assign(Object.assign({}, item), { id: exports.buildDocumentId(entityType, entityUuid, item.navtitle, locale) }))),
                total: json.length,
            };
        },
        getOne: async ({ id }) => {
            ...
            return {
                data: Object.assign(Object.assign({}, json), { id: exports.buildDocumentId(entityType, entityUuid, json.navtitle, json.locale) }),
            };
        },
        create: async (_a) => {
        ...
        delete: async ({ id }) => {
            ...
            const data = __rest((await ra_core_1.fetchUtils.fetchJson(url, {
                credentials: 'include',
                method: 'DELETE',
            })).json, []);
            return {
                data: Object.assign(Object.assign({}, data), { id: exports.buildDocumentId(entityType, entityUuid, data.navtitle, data.locale) }),
            };
        },
    };
};
