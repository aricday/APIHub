...
describe('Documentation', () => {
    ...
    test('should display a tree of the documents', async () => {
        ...
        fireEvent.click(getByLabelText('resources.apis.expand_documentation'));
    ...
    test('should allow to expand and collapse using the icon buttons', async () => {
        ...
        fireEvent.click(
            getAllByLabelText('resources.apis.collapse_documentation')[1]
        );
        await wait(() => {
            expect(queryByText('child-child')).toBeNull();
        });
        fireEvent.click(
            getAllByLabelText('resources.apis.collapse_documentation')[0]
        );
        await wait(() => {
    ...
    test('should allow to create a new root document', async () => {
        ...
        fireEvent.click(
            getByLabelText(
                'resources.apis.documentation.actions.new_document_button'
            )
        );
    ...
    test('should allow to delete a document with children', async () => {
        ...
        fireEvent.click(
            getByText(
                'resources.apis.documentation.fields.select_documentation_locale'
            )
        );
    ...
    test('should allow to move an existing document', async () => {
        jest.setTimeout(10000);
        ...
        // The sibling child should be visible because the current document
        // parent should be expanded
        await within(getByRole('dialog')).findByText(
            'another_child_same_level'
        );

        const moveAsRootItem = await within(getByRole('dialog')).findByText(
            'resources.documents.actions.move_as_root_item'
        );
        fireEvent.click(moveAsRootItem);
        await within(getByRole('dialog')).findByText(
            'resources.documents.actions.move_as_first_child'
        );
        fireEvent.click(
            within(getByRole('dialog')).getByText('ra.action.save')
        );
