...
function listDocuments(database) {
    var _this = this;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, promisify_1.promisify(database.documents.find({
                            type: type,
                            typeUuid: typeUuid,
                            locale: locale,
                        }).fetch)];
...
function postDocument(database) {
    var _this = this;
    return function (schema, request) { return __awaiter(_this, void 0, void 0, function () {
        var document;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, promisify_1.promisify(database.documents.upsert.bind(database.documents), __assign(__assign({}, document), { uuid: faker_1.default.random.uuid(), typeUuid: request.params.typeUuid }))];
                case 1:
                    _a.sent();
    ...
    return function (schema, request) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    document = JSON.parse(request.requestBody);
                    return [4 /*yield*/, promisify_1.promisify(database.documents.upsert.bind(database.documents), __assign(__assign({}, document), { typeUuid: request.params.typeUuid }))];
                case 1:
                    _a.sent();
                    return [2 /*return*/, request.requestBody];
            }
...
function getDocumentsTree(database) {
    var _this = this;
    return function (schema, request) { return __awaiter(_this, void 0, void 0, function () {
        var _a, type, typeUuid, locale, documents;
        return __generator(this, function (_b) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    locale = request.queryParams.locale;
                    return [4 /*yield*/, promisify_1.promisify(database.documents.findOne.bind(database.documents), {
                            type: type,
                            typeUuid: typeUuid,
                            navtitle: navtitle,
                            locale: locale,
