        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, promisify_1.promisify(database.userContexts.find().fetch)];
                case 1:
                    users = _b.sent();
                    ...
                    currentUser_1.setCurrentUser(user);
                    return [2 /*return*/, {
                            respCode: '200',
...
exports.login = login;
function getPublicKey(database) {
...
function checkUserNameIsUnique(database) {
    var _this = this;
    return function (schema, request) { return __awaiter(_this, void 0, void 0, function () {
...
exports.checkUserNameIsUnique = checkUserNameIsUnique;
function passwordResetTokenValidate(database) {
    return function (schema, request) {
        return {
            status: 200,
        };
...
exports.passwordResetTokenValidate = passwordResetTokenValidate;
function updateMyPassword(database) {
    return function (schema, request) {
        return {
            status: 200,
        };
...
function logout(database) {
    return function (schema, request) {
        currentUser_1.deleteCurrentUser();
        return {
            status: 200,
        };
    };
...
function getAccountSetup(database) {
    return function (schema, request) {
...
exports.getAccountSetup = getAccountSetup;
function putAccountSetup(database) {
    return function (schema, request) {
        var token = request.queryParams.token;
        if (token === 'IamLordVoldemort') {
            return {
...
exports.putAccountSetup = putAccountSetup;
function getUserContexts(database) {
    return function (schema, request) {
        return currentUser_1.getCurrentUser();
    };
}
