...
function listApplications(database) {
    ...
    return function (schema, request) { return __awaiter(_this, void 0, void 0, function () {
        var _a, page, size, order, sort, apiUuid, $select, filter, finalPage, finalSize, finalSort, finalOrder, finalFilter, totalElements, results;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, promisify_1.promisify(database.applications.find(finalFilter).fetch)];
                case 1:
                    totalElements = (_c.sent()).length;
                    return [4 /*yield*/, promisify_1.promisify(database.applications.find(finalFilter, {
                            limit: finalSize,
